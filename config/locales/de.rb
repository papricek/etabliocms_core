...
unless defined?(DeutschLocaleI18n::ERROR_MESSAGES)
  module DeutschLocaleI18n
    ERROR_MESSAGES = {
...
{ :'de' => {
    ...
    :errors => {
      ...
      :messages => DeutschLocaleI18n::ERROR_MESSAGES
    },
    ...
    :activerecord => {
      :errors => {
        ...
        }.merge(DeutschLocaleI18n::ERROR_MESSAGES),
        :template => {
          :header   => {
