...
unless defined?(EnglishLocaleI18n::ERROR_MESSAGES)
  module EnglishLocaleI18n
    ERROR_MESSAGES = {
...
{ :'en' => {
    ...
    :errors => {
      ...
      :messages => EnglishLocaleI18n::ERROR_MESSAGES
    },
    ...
    :activerecord => {
      :errors => {
        ...
        }.merge(EnglishLocaleI18n::ERROR_MESSAGES),
        :template => {
          :header   => {
